...
14. Next, open the "NAMEOFDRIVER.java" file by clicking it. Hit the green run icon, which is a green circle with a white triangle inside of it. The program should run, and you should see a separate window open with the Java Pong Game running on it. 
...
7. Inside the "Java-Pong-master" folder on your terminal, type the following command: `javac NAMEOFDRIVER.java`. It is important that you include the "c" at the end of "java" (no spaces).
8. After typing the command above, type this command: `java NAMEOFDRIVER.java`. Do NOT include a "c" at the end of "java" in this command.
